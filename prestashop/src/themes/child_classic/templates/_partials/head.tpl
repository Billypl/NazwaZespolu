...
{block name='head_seo'}
  <title>{block name='head_seo_title'}Sklep z koralikami • Akcesoria do biżuterii • pasart.pl{/block}</title>
...
{block name='head_icons'}
  ...
  <link rel="preload" crossorigin="anonymous" as="font" href="/img/fontello.woff">
{/block}
