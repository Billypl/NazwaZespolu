...
<div class="col-md-6 links">
  ...
  {if $linkBlock.id == 1}
  <div class="col-md-6 wrapper footer_half_column">
{/if}
    <div class="col-md-6 wrapper footer_column fc{$linkBlock.id}">
      <p class="link_title">{$linkBlock.title}</p>
      <div class="title clearfix hidden-md-up" data-target="#footer_sub_menu_{$linkBlock.id}" data-toggle="collapse">
        <span class="link_title">{$linkBlock.title}</span>
