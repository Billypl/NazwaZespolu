...
LOCAL_FILES=("../../prestashop/docker-compose.prod.yaml" "../../prestashop/dbdump/dump.sql" "cluster/init_db.sh" "cluster/cluster_helper.sh" "cluster/deployment_process.sh" "cluster/download_img.sh")  
